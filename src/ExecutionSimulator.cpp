...
ExecutionSimulator::ExecutionSimulator(const FeeModel& feeModel) : _feeModel(feeModel) {}

ExecutionResult ExecutionSimulator::simulate(const Market& market, const std::unordered_map<std::string, OrderBook>& books, double requestedQuantity) const {
